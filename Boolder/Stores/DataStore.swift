...
class DataStore : ObservableObject {
    ...
    let areas = [
        ...
        Area(id: 6,  name: "Cuvier Est",                        problemsCount: 191, latitude: 48.44632258444,      longitude: 2.63986497849,       published: true),
        Area(id: 7,  name: "Apremont",                          problemsCount: 154, latitude: 48.43522293535,      longitude: 2.62890814662,       published: true),
        ...
        Area(id: 18, name: "Diplodocus",                        problemsCount: 137, latitude: 48.37110784942,      longitude: 2.53313183248,       published: true),
        Area(id: 19, name: "Rocher des Potets",                 problemsCount: 84,  latitude: 48.38323333672,      longitude: 2.52603470743,       published: true),
        Area(id: 20, name: "Apremont Ouest",                    problemsCount: 202, latitude: 48.43660385165,      longitude: 2.62639759898,       published: true),
        ...
        Area(id: 27, name: "Jean des Vignes",                   problemsCount: 111, latitude: 48.38402069871,      longitude: 2.52459167898,       published: true),
        Area(id: 28, name: "La Ségognole",                      problemsCount: 147, latitude: 48.38038216187,      longitude: 2.50413246386,       published: true),
        Area(id: 29, name: "Beauvais Nainville",                problemsCount: 378, latitude: 48.50298942153,      longitude: 2.4803325507,        published: true),
        Area(id: 30, name: "J.A. Martin",                       problemsCount: 434, latitude: 48.36021275846,      longitude: 2.5355189985,        published: true),
        Area(id: 31, name: "Franchard Cuisinière Crêtes Sud",   problemsCount: 74,  latitude: 48.40998612911,      longitude: 2.60897933901,       published: true),
        ...
        Area(id: 34, name: "Franchard Sablons",                 problemsCount: 164, latitude: 48.40932024047,      longitude: 2.59555220068,       published: true),
        Area(id: 35, name: "Rocher de la Cathédrale",           problemsCount: 70,  latitude: 48.36369858932,      longitude: 2.53304599643,       published: true),
        Area(id: 36, name: "Franchard Hautes Plaines",          problemsCount: 180, latitude: 48.40903180472,      longitude: 2.59788572252,       published: true),
        Area(id: 37, name: "Franchard Meyer",                   problemsCount: 109, latitude: 0,                   longitude: 0,                   published: false),
        Area(id: 38, name: "Franchard Sablons Carriers",        problemsCount: 39,  latitude: 48.4097475497,       longitude: 2.58674919069,       published: true),
        Area(id: 39, name: "Franchard Raymond",                 problemsCount: 90,  latitude: 0,                   longitude: 0,                   published: false),
        Area(id: 40, name: "Cuvier Merveille",                  problemsCount: 41,  latitude: 48.44429429571,      longitude: 2.65221654832,       published: true),
        ...
        Area(id: 44, name: "Cuvier Nord",                       problemsCount: 152, latitude: 48.44707783419,      longitude: 2.63957664236,       published: true),
        Area(id: 45, name: "Cuvier Bellevue",                   problemsCount: 211, latitude: 0,                   longitude: 0,                   published: false),
        Area(id: 46, name: "Apremont Bizons",                   problemsCount: 347, latitude: 0,                   longitude: 0,                   published: false),
        Area(id: 47, name: "Rocher Canon Ouest",                problemsCount: 89,  latitude: 48.46165668742,      longitude: 2.65914737642,       published: true),
        Area(id: 48, name: "Apremont Butte aux Dames",          problemsCount: 300, latitude: 0,                   longitude: 0,                   published: false),
        Area(id: 49, name: "Apremont Solitude",                 problemsCount: 107, latitude: 48.4359276291,       longitude: 2.63337135047,       published: true),
        Area(id: 50, name: "Rocher d'Avon",                     problemsCount: 217, latitude: 48.39356426743,      longitude: 2.72187351644,       published: true),
        Area(id: 51, name: "Restant du Long Rocher",            problemsCount: 199, latitude: 48.35360399987,      longitude: 2.73038685054,       published: true),
        ...
        Area(id: 67, name: "La Reconnaissance",                 problemsCount: 132, latitude: 0,                   longitude: 0,                   published: false),
        Area(id: 68, name: "Restant du Long Rocher Nord",       problemsCount: 67,  latitude: 48.35687284127,      longitude: 2.7309071964,        published: true),
        Area(id: 69, name: "Apremont Est",                      problemsCount: 334, latitude: 48.43519089801,      longitude: 2.63057380646,       published: true),
    ]
