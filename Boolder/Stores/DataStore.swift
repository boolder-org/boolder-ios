...
class DataStore : ObservableObject {
    ...
    let areas = [
        ...
        Area(id: 23, name: "Buthiers",                problemsCount: 293, latitude: 48.29321041383,      longitude: 2.4363550517,        published: false),
        Area(id: 24, name: "Rocher Saint-Germain",    problemsCount: 186, latitude: 48.43963959475,      longitude: 2.68572270602,       published: false),
